...
const CACHE='scouting-shell-v2';
self.addEventListener('install',e=>{e.waitUntil(caches.open(CACHE).then(c=>c.addAll(['/','/index.html','/manifest.json','/icon.svg','/icon-192.png','/icon-512.png'])).then(()=>self.skipWaiting()))});
